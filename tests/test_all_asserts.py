...
class AllAssertsTests(unittest.TestCase):
    ...
    @unittest.skip("En progreso, será habilitada nuevamente")
    def test_skip(self):
        self.assertEqual("Hi", "bye")

    @unittest.skipIf(SERVER == "server_b", "Saltado porque no estamos en el server correcto")
